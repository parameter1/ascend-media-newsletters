...
const config = {
  ...
  'aad-enewsletter-1': {
    ...
    channelButtons: {
      bgColor: '#76bc43',
      links: [
        { label: 'Meeting Program', href: 'https://ia2024.aad.org/sessions', target: '_blank' },
        { label: 'Registration', href: 'https://www.aad.org/member/meetings-education/ia24/registration', target: '_blank' },
      ],
    },
  },
  'aua-daily-domestic': {
  ...
  'asa-today-2022': {
    ...
    channelButtons: {
      bgColor: '#8a84d6',
      links: [
        { label: 'ASA My Meeting App', href: 'https://m.core-apps.com/dl/anes24', target: '_blank' },
