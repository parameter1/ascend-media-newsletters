  ...
  acep: {
    ...
    socialMedia: {
      ...
      links: [
        ...
        { provider: 'instagram', href: 'https://twitter.com/acepnow', target: '_blank' },
        { provider: 'twitter', href: 'https://www.youtube.com/channel/UCXJmNBwfRY-qyj0CIpVH-WA', target: '_blank' },
        { provider: 'instagram', href: 'TBD', target: '_blank' },
      ],
    },
    ctaLinkStyle: {
      color: '#ED8800',
