module.exports = {
  ...
  aao: {
    ...
    headerImageSrc: '/files/base/ascend/hh/image/static/aao-hns/AAOHNSF23_eNewsHeader.jpeg',
    socialMedia: {
      imagePath: '/files/base/ascend/hh/image/static',
      links: [
  ...
  asa: {
    ...
    footer: {
      bgColor: '#1226aa',
      address: 'ASA Headquarters<br/>1061 American Lane<br/>Schaumburg, IL 60173-4973',
  ...
  shm: {
    ...
    headerImageSrc: '/files/base/ascend/hh/image/static/shm/SHM_650_1300_newsletter_1300.png',
    socialMedia: {
      imagePath: '/files/base/ascend/hh/image/static',
      links: [
